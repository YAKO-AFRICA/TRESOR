            ...
            <div class="col product-item">
                <div class="card">
                    ...
                    @elseif ($product->CodeProduit == 'DOIHOO')
                        ...
                        @can('Demarrer une souscription')
                        <div class="card-footer text-center">
                            <a href="{{ route('prod.createLffun') }}" class="btn-prime btn-prime-two d-block">Souscrire</a>
                        </div>
                        @else
                        <div class="card-footer text-center">
                            <a href="#" class="btn-prime btn-prime-two d-block text-danger">Vous n'etes pas autorisé</a>
                        </div>
                        @endcan
                    @else
                        @can('Demarrer une souscription')
