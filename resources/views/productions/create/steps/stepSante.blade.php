<div id="test-l-5" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger5">
    ...
    <div class="g-3">
        ...
        <input type="hidden" name="souscriptionDataFinal" id="souscriptionDataFinal" value="">
    ...
    <script>
        ...
        document.getElementById('btn-next-sante').addEventListener('click', function() {
            const SouscriptionDataFinal = JSON.parse(sessionStorage.getItem('simulationData')) || {};
            document.getElementById('souscriptionDataFinal').value = JSON.stringify(SouscriptionDataFinal);

            console.log("souscriptionDataFinal dans stepResume:", SouscriptionDataFinal);
