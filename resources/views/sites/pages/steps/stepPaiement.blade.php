                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="modepaiement" type="radio" value="SOLDE"
                                id="SOLDE" checked required readonly>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="modepaiement" type="radio" value="VIR"
                                id="Virement_bancaire" required disabled>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" name="modepaiement" type="radio"
                                value="CARTE" id="carte_bancaire" required disabled>
                    ...
                    <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="number" class="form-control" id="primepricipale" name="primepricipale"
                                    min="0" value="16900" required readonly>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="fraisAdhesion" class="form-label">Frais d'adhesion :</label>
                                <input type="number" value="0" class="form-control" id="fraisAdhesion" name="fraisAdhesion"
                                    min="0" readonly>
                            </div>
                            <div class="col-12 mb-3">
                                <label for="capital" class="form-label">Capital souscrit :</label>
                                <input type="text" class="form-control" value="4000000" id="capital" name="capital" required readonly>
                                
                            </div>
                            <div class="col-12 mb-3">
                                <label for="duree" class="form-label">Durée de mes cotisations :</label>
                                <input type="number" class="form-control" id="duree" name="duree" value="1" min="0" readonly> 
                            </div>
